...
Config.Zone = {
	...
	Blips = {
		...
		Color = 1,
		Size = 1.3,
		Text = '<font face="font4thai">[งาน] เก็บน้ำมัน</font>'
	}
}
...
Config.ItemName = "crude_oil"    -- ไอเทมที่ดรอป
...
-- Prop  
Config.object = 'prop_oilcan_01a' -- ออฟเจ็คบนพื้น
