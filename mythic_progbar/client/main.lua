...
function Progress(action, finish)
    ...
    if not IsEntityDead(GetPlayerPed(-1)) or mythic_action.useWhileDead then
        if not isDoingAction then
            ...
            print('Action Already Performing') -- Custom by PHUMPIPATY23 SCSHOP
        end
    else
        print('Cannot do action while dead') -- Custom by PHUMPIPATY23 SCSHOP
    end
end
...
function DisableActions(ped)
    ...
    if mythic_action.controlDisables.disableCombat then
		...
		DisableControlAction(0, 18, true) -- disable F
		DisableControlAction(0, 23, true) -- disable F
        DisableControlAction(0, 24, true) -- disable attack
        DisableControlAction(0, 25, true) -- disable aim
        DisableControlAction(1, 37, true) -- disable weapon select
		DisableControlAction(0, 29, true) -- B
		DisableControlAction(0, 38, true) -- disable weapon
        DisableControlAction(0, 47, true) -- disable weapon
		DisableControlAction(0, 49, true) -- disable weapon
        DisableControlAction(0, 58, true) -- disable weapon
		-- DisableControlAction(0, 73, true) -- X
		DisableControlAction(0, 75, true) -- disable weapon
        DisableControlAction(0, 140, true) -- disable melee
        DisableControlAction(0, 141, true) -- disable melee
        DisableControlAction(0, 142, true) -- disable melee
        DisableControlAction(0, 143, true) -- disable melee
		DisableControlAction(0, 155, true) -- disable melee
		DisableControlAction(0, 170, true) -- F3
		DisableControlAction(0, 176, true) -- disable melee
		DisableControlAction(0, 191, true) -- disable melee
		DisableControlAction(0, 201, true) -- disable melee
		DisableControlAction(0, 215, true) -- disable melee
		DisableControlAction(0, 245, true) -- T
		DisableControlAction(0, 246, true) -- Y
        DisableControlAction(0, 263, true) -- disable melee
        DisableControlAction(0, 264, true) -- disable melee
        DisableControlAction(0, 257, true) -- disable melee
		DisableControlAction(0, 289, true) -- disable weapon
