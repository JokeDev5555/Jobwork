...
Config.Zone = {
	...
	Blips = {
		...
		Color = 21,
		Size = 1.0,
		Text = '<font face="font4thai">[งาน] ซากรถ</font>'
	}
}
...
Config.ItemName = "iron_ore"    -- ไอเทมที่ดรอป
...
-- Prop  
Config.object = 'prop_rub_carwreck_10' -- ออฟเจ็คบนพื้น
