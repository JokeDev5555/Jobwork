...
Config.ServerEventname = "cottonone" 
Config.Zone = {
	Pos = {  
		x = 2809.080078125, 
		y = 4765.39013671875, 
	...
	Blips = {
		...
		Color = 0,
		Size = 0.8,
		Text = '<font face="font4thai">[งาน] เก็บฝ้าย</font>'
	}
}
...
Config.ItemName = "cotton"    -- ไอเทมที่ดรอป
...
-- Prop  
Config.object = 'prop_bush_med_07' -- ออฟเจ็คบนพื้น
