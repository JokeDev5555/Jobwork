...
Config.ServerEventname = "aidkita" 
Config.Zone = {
	Pos = {  
		x = -579.7,
		y = 6359.28,
	...
	Blips = {
		...
		Color = 35,
		Size = 1.0,
		Text = '<font face="font4thai">[งาน] กล่องพยาบาล</font>'
	}
}
...
Config.ItemName = "first_aidkit"    -- ไอเทมที่ดรอป
...
-- Prop  
Config.object = 'v_ret_ta_firstaid' -- ออฟเจ็คบนพื้น
